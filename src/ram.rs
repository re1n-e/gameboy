...
pub trait RamReadWrite {
    fn wram_read(&self, address: &mut u16) -> u8;
    fn wram_write(&mut self, address: &mut u16, value: u8);
    fn hram_read(&self, address: &mut u16) -> u8;
    fn hram_write(&mut self, address: &mut u16, value: u8);
}
